...
export function CaseStudyPreview({ data, palette, editable = false, onChange }: Props) {
  ...
  return (
    <div id="cs-root" style={{ fontFamily: "'Open Sans', Arial, sans-serif", fontSize: "9pt", color: "#1a1a1a", background: "#fff", width: "794px", margin: "0 auto" }}>
      ...
      {/* ─── PAGE 1 ──────────────────────────────────────────────────────── */}
      <div className="cs-page-container" style={{ width: "794px", height: "1123px", boxSizing: "border-box", display: "flex", flexDirection: "column", position: "relative", overflow: "hidden" }}>
        
        {/* CLIENT STRIP */}
        <div style={{ background: light, borderBottom: `3px solid ${accent}`, padding: "7px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "45px", boxSizing: "border-box" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div style={{ fontSize: "7pt", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1.5px", color: accent }}>Client</div>
            <div style={{ width: "2px", height: "18px", background: accent, borderRadius: "1px" }} />
        ...
        {/* HEADER */}
        <div style={{ background: primary, color: "white", display: "flex", alignItems: "stretch", height: "96px", boxSizing: "border-box" }}>
          <div style={{ background: primary, width: "185px", minWidth: "185px", display: "flex", alignItems: "center", justifyContent: "center", padding: "14px 16px" }}>
            <img id="cs-logo" src={logoUrl} alt="Permionics" style={{ width: "155px", display: "block" }} />
          </div>
        ...
        <div style={{ display: "flex", alignItems: "stretch", flex: 1, minHeight: 0 }}>
          {/* LEFT SIDEBAR */}
          <div style={{ width: "185px", minWidth: "185px", background: light, borderRight: `1px solid ${lightBorder}`, padding: "14px 12px", boxSizing: "border-box" }}>
          ...
          {/* MAIN CONTENT */}
          <div style={{ flex: 1, padding: "14px 20px", minWidth: 0, boxSizing: "border-box" }}>
            {data.statBar && (
        ...
        {/* PAGE 1 FOOTER */}
        <div style={{ background: primary, padding: "8px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "36px", boxSizing: "border-box" }}>
      ...
      {/* ─── PAGE DIVIDER IN BROWSER ──────────────────────────────────────── */}
      <div className="cs-page-divider print:hidden" style={{ borderTop: "2px dashed #cbd5e1", margin: "16px 0" }} />
      ...
      <div className="cs-page-container" style={{ width: "794px", height: "1123px", boxSizing: "border-box", display: "flex", flexDirection: "column", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ background: primary, color: "white", display: "flex", alignItems: "stretch", height: "96px", boxSizing: "border-box" }}>
          <div style={{ background: primary, width: "185px", minWidth: "185px", display: "flex", alignItems: "center", justifyContent: "center", padding: "14px 16px" }}>
            <img id="cs-logo-p2" src={logoUrl} alt="Permionics" style={{ width: "155px", display: "block" }} />
          </div>
          <div style={{ background: accent, flex: 1, padding: "14px 24px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            <div style={{ fontSize: "7px", letterSpacing: "3px", textTransform: "uppercase", color: headerCat, marginBottom: "5px", fontWeight: 600 }}>
              {data.categoryLabel}
