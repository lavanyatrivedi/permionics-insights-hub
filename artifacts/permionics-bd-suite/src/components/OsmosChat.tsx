        ...
        >
          ...
          >
            <div className="relative">
              <img src={botAvatar} alt="OSMOS" className="w-9 h-9 rounded-xl object-cover" />
            ...
            {messages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center space-y-3 px-4">
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center"
                  ...
                  <img src={botAvatar} alt="OSMOS" className="w-12 h-12 rounded-xl object-cover osmos-blob" />
                </div>
                <div>
              ...
              messages.map((m, i) => (
                <div key={i} className={`flex gap-2.5 ${m.role === "user" ? "flex-row-reverse" : ""}`}>
                  {m.role === "assistant" && (
                    <img src={botAvatar} alt="OSMOS" className="w-7 h-7 rounded-lg object-cover flex-shrink-0 mt-0.5" />
                  )}
                  <div
